// https://github.com/soyHenry/Prep-Course/blob/main/03-JS-II/homework/homework.js
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if(num1.Math.sign() != 1 || num2.Math.sign() != 1 || num3.Math.sign() != 1){
    return 'negativo'
  } else {
    return 'positivos'
  }
...
}console.log(tieneTresDigitos(644))
